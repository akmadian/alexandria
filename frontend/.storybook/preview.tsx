        ...
        options: {
            storySort: {
                order: [
                    ...
                    "Primitives",
                    ["Button", "ToggleButton", "Checkbox", "Switch", "SegmentedControl", "TextField", "Rating", "Badge", "Icon", "LabelSwatch", "Row", "ControlRow", "ControlGroup", "PanelSection", "NoticeRegion", "Menu", "Tree"],
                ],
            },
        },
    },
