...
parsing tests. See also [docs/coding-guidelines.md](../../docs/coding-guidelines.md)
(the "accept `io.Reader`, return a struct" rule directly shapes what's unit-
testable here) and [docs/repo-hygiene-backend.md](../../docs/repo-hygiene-backend.md) (CI/coverage/vulncheck
