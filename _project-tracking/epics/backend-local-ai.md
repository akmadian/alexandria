...
[ops-telemetry.md](ops-telemetry.md)/[ops-release.md](ops-release.md). Local-only by design:
...
than inventing new architecture), the dependency-fleet work (D4/D5; remainder in `../DEFERRED.md` §10)
