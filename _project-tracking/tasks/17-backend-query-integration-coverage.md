# 17 — Query-layer integration test coverage gaps

**Areas:** backend. **Blocked by:** nothing. Written during the query-layer round (2026-07-08);
each gap below closes with an integration test in `internal/sqlite`.
