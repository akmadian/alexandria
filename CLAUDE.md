...
- Deferred performance optimizations are marked in code with a searchable
  `// PERF:` comment naming the idea and its trigger.
- A behavioral fix ships with the test that would have caught it, in the
  same change.
